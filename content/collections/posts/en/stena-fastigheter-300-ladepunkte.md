    ...
    text:
      ...
      -
        ...
        content:
          -
            type: text
            text: 'The scaling was carried out step by step via networked SmartHubs. Each new hub is automatically integrated into the system, and load management adapts dynamically. For residents, this means: reliable charging directly at their parking space, without waiting times or manual coordination.'
  -
    id: block-2-2
    type: text
    heading: 'Scaling Without Complexity'
    text:
      -
        type: paragraph
        content:
